...
const Contact = () => {
  return (
    <div id="contact" className="p-10 max-w-4xl m-auto">
      <h1 className="text-3xl text-center mb-8 flex justify-center gap-2" >
   
        Let's <span className="text-teal-400 flex gap-2 ">Establish a Connection <TbPlugConnectedX fontSize={"40px"}/>  </span>
      </h1>
